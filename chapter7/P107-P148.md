...
| Time | Core C1 | Core C2 | LLC/Memory |
|------|---------|---------|-------------|
| 0 | A:I<br>B:M[0] | A:S[0]<br>B:I | A:S[0]<br>B:M |
| 1 | A:GetM from Core C1/M[0]<br>store A = 1<br>B:M[0] | A:S[0]<br>B:I | A:S[0]<br>B:M |
| 2 | A:M[1]<br>store B = 1<br>B:M[1] | A:S[0]<br>B:I | A:GetM from Core C1/M<br>B:M |
| 3 | A:M[1]<br>B:GetS from Core C2/S[1] | A:S[0]<br>B:I | A:M<br>B:GetS from Core C2/S[1] |
| 4 | A:M[1]<br>B:S[1] | A:S[0]<br>B:GetS from Core C2/S[1]<br>r1 = B[1] | A:M<br>B:S[1] |
| 5 | A:M[1]<br>B:S[1] | A:S[0]<br>r2 = A[0]<br>B:S[1] | A:M<br>B:S[1] |
| 6 | A:M[1]<br>B:S[1] | A:GetM from Core1/I<br>B:S[1] | A:M<br>B:S[1] |
...
| 2 | A:M[1]<br>store B = 1<br>B:M[1] | A:S[0]<br>B:I | A:GetM from Core C1/M<br>B:M |
| 3 | A:M[1]<br>B:GetS from Core C2/S[1] | A:S[0]<br>B:I | A:M<br>B:GetS from Core C2/S[1] |
| 4 | A:M[1]<br>B:S[1] | A:GetM from Core1/I<br>B:I | A:M<br>B:S[1] |
| 5 | A:M[1]<br>B:S[1] | A:I<br>B:GetS from Core C2/S[1]<br>r1 = B[1] | A:M<br>B:S[1] |
| 6 | A:GetS from Core C2/S[1]<br>B:S[1] | A:GetS from Core C2/S[1]<br>r2 = A[1]<br>B:S[1] | A:GetS from Core C1/S[1]<br>B:S[1] |
